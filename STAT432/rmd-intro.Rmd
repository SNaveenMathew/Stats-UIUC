...
author: Ruoqing Zhu, modified from David Dalpiaz's original file
date: 
abstract: |
  This document was originally created by David Dalpiaz. The original file can be loaded from his R4SL online text book. I made some slight modifications. This is by no means a comprehensive guide, and there are many other resources available online. 
output:
  html_document: 
